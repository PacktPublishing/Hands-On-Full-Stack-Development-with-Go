...
$packages["main"] = (function() {
	var $pkg = {}, $init, js, MI, ptrType, funcType, mapType, ptrType$1, main, New;
	js = $packages["github.com/gopherjs/gopherjs/js"];
	MI = $pkg.MI = $newType(0, $kindStruct, "main.MI", true, "main", true, function(MIType_, Price_, Color_, Age_) {
		this.$val = this;
		if (arguments.length === 0) {
			this.MIType = "";
			this.Price = 0;
	...
	ptrType$1 = $ptrType(MI);
	main = function() {
		$global.musicalInstruments = $externalize($makeMap($String.keyFor, [{ k: "New", v: new funcType(New) }]), mapType);
	};
	MI.ptr.prototype.SetMIType = function(s) {
		var mi, s;
		mi = this;
		mi.MIType = s;
	};
	MI.prototype.SetMIType = function(s) { return this.$val.SetMIType(s); };
	MI.ptr.prototype.GetMIType = function() {
		var mi;
		mi = this;
		return mi.MIType;
	};
	MI.prototype.GetMIType = function() { return this.$val.GetMIType(); };
	MI.ptr.prototype.SetPrice = function(f) {
		var f, mi;
		mi = this;
		mi.Price = f;
	};
	MI.prototype.SetPrice = function(f) { return this.$val.SetPrice(f); };
	MI.ptr.prototype.GetPrice = function() {
		var mi;
		mi = this;
		return mi.Price;
	};
	MI.prototype.GetPrice = function() { return this.$val.GetPrice(); };
	MI.ptr.prototype.SetColor = function(c) {
		var c, mi;
		mi = this;
		mi.Color = c;
	};
	MI.prototype.SetColor = function(c) { return this.$val.SetColor(c); };
	MI.ptr.prototype.GetColor = function() {
		var mi;
		mi = this;
		return mi.Color;
	};
	MI.prototype.GetColor = function() { return this.$val.GetColor(); };
	MI.ptr.prototype.SetAge = function(a) {
		var a, mi;
		mi = this;
		mi.Age = a;
	};
	MI.prototype.SetAge = function(a) { return this.$val.SetAge(a); };
	MI.ptr.prototype.GetAge = function() {
		var mi;
		mi = this;
		return mi.Age;
	};
	MI.prototype.GetAge = function() { return this.$val.GetAge(); };
	New = function() {
		return js.MakeWrapper(new MI.ptr("", 0, "", 0));
	};
	$pkg.New = New;
	ptrType$1.methods = [{prop: "SetMIType", name: "SetMIType", pkg: "", typ: $funcType([$String], [], false)}, {prop: "GetMIType", name: "GetMIType", pkg: "", typ: $funcType([], [$String], false)}, {prop: "SetPrice", name: "SetPrice", pkg: "", typ: $funcType([$Float64], [], false)}, {prop: "GetPrice", name: "GetPrice", pkg: "", typ: $funcType([], [$Float64], false)}, {prop: "SetColor", name: "SetColor", pkg: "", typ: $funcType([$String], [], false)}, {prop: "GetColor", name: "GetColor", pkg: "", typ: $funcType([], [$String], false)}, {prop: "SetAge", name: "SetAge", pkg: "", typ: $funcType([$Int], [], false)}, {prop: "GetAge", name: "GetAge", pkg: "", typ: $funcType([], [$Int], false)}];
	MI.init("", [{prop: "MIType", name: "MIType", embedded: false, exported: true, typ: $String, tag: ""}, {prop: "Price", name: "Price", embedded: false, exported: true, typ: $Float64, tag: ""}, {prop: "Color", name: "Color", embedded: false, exported: true, typ: $String, tag: ""}, {prop: "Age", name: "Age", embedded: false, exported: true, typ: $Int, tag: ""}]);
	$init = function() {
		$pkg.$init = function() {};
		/* */ var $f, $c = false, $s = 0, $r; if (this !== undefined && this.$blk !== undefined) { $f = this; $c = true; $s = $f.$s; $r = $f.$r; } s: while (true) { switch ($s) { case 0:
		$r = js.$init(); /* */ $s = 1; case 1: if($c) { $c = false; $r = $r.$blk(); } if ($r && $r.$blk !== undefined) { break s; }
